...
import { ActivityIndicator, Alert, RefreshControl, ScrollView, StyleSheet, Switch, TouchableOpacity, View, useColorScheme } from 'react-native'
              ...
              <View style={styles.planContent}>
                <View style={{ flex: 1 }}>
                  ...
                  <Typography variant="body" color="textSecondary" style={{ marginTop: 4 }}>
                    {format.duration(plan.duration_seconds)} • {format.dataSize(plan.data_bytes)}
                  </Typography>
                </View>
