...
-- PREREQUISITE: Run create-test-users.js FIRST to create authenticated users

-- ============================================================================
-- UPDATE TEST USER PROFILES
-- ============================================================================
-- Note: Users should already exist from create-test-users.js
-- This updates their profiles with historical dates and specific balances
...
BEGIN
  ...
  RAISE NOTICE 'Users: %', (SELECT COUNT(*) FROM public.profiles WHERE id LIKE '00000000-0000-0000-0001-%');
